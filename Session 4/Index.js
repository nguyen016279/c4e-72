...
3.1. Data type of outermost layer is objects
...
if (k == 'debug') {
    alert(`${k}: the process of figuring in out why your program has a certain error and how to fix it`)
}else{
    alert(`we cuold not find your word: ${k}`)
}
4.2
let keyword = []
let explanation = []
...
if (k == keyword) {
    ...
    let ex = prompt(`we could not find your word: ${k},leave your explanation:`)
    keyword.push(k)
    explanation.push(ex)
    alert(`Done`)
}
...
for (let i = 0; i < products.length; i++) {
    ...
    console.log('Price:',products[i].price)
    console.log('Color: ',products[i].category)
...
let provider = prompt('Enter a provider')
for (let p in products){
    for (let i=0; i<products[p].providers.length; i++){
        if (provider == products[p].providers[i]){
        console.log('------------------------')
...
let f = prompt('enter your command (new,delete,update,complete)').toLowerCase()
if (f == 'new') {
    let n = prompt('enter name new task')
    learningTask.push(
        {
            name: n,
            complete: false
    ...
    let p = Number(prompt('number posittion:'))-1
    learningTask.splice(p,1)
    for (let i = 0;i<learningTask.length;i++){
        console.log(`${i+1}.${learningTask[i]['name']} \n  Complete: ${learningTask[i]['complete']}`)
    }
}else if(f == 'update'){
    let c = Number(prompt("Enter the posittion you want to edit")) - 1
    if (Number.isNaN(c)){
        console.log('pls enter number')
    }else{
        if(c>=learningTask.length){
            console.log('Pls enter smaller number')
        }else{
    ...
    let d = Number(prompt("Enter the posittion you want to edit")) - 1
    if (Number.isNaN(d)){
        console.log('pls enter number')
    }else{
        if(d>=learningTask.length){
            console.log('Pls enter smaller number')
        }else{
            learningTask[d].complete = true;
            for (let i = 0;i<learningTask.length;i++){
                console.log(`${i+1}.${learningTask[i]['name']} \n  Complete: ${learningTask[i]['complete']}`)
            }
        }
    ...
    console.log('command doesn't exist, pls enter again!')
}
*/
/*Ex7
clear()
...
const jobHits = dataJob.hits;
console.log("job hits");
console.log(jobHits);
const firstJobHit = dataJob.hits[0];
